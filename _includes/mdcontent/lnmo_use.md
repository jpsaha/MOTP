...
- also aim
  - to spread awareness for the [Mathematics Olympiad programme in India]({{ site.data.lnk.molink }}), conducted by the [Homi Bhabha Centre for Science Education]({{ site.data.lnk.hbcselink }}) (HBCSE), which is the <span style="color: red"> only programme </span> in India leading to participation in the following <span style="color: green"> International </span> Mathematical Olympiads --- [IMO](https://www.imo-official.org/), [APMO](https://www.apmo-official.org/), [EGMO](https://www.egmo.org/). <span style="color: red">No other contests are recognized. </span>
